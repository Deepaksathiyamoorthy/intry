    ...
    return (
        <div className="market-launch">
            <div className="container">
                ...
                <ScrollReveal animation="fadeInUp" delay="0.5s">
                    <div className="content-section">
                        <h2>Our Services</h2>
                ...
                <ScrollReveal animation="fadeInUp" delay="0.6s">
                    <div className="content-section">
                ...
                <ScrollReveal animation="fadeInUp" delay="0.7s">
                    <div className="content-section">
                ...
                <ScrollReveal animation="fadeInUp" delay="0.8s">
                    <motion.div
